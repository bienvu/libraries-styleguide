...
<?php if ($pager == 'custom_field') : ?>

  <div id="field-slideshow-<?php print $slideshow_id; ?>-pager" class="field-slideshow-pager slides-<?php print count($items); ?>">
    <?php print $pager_fields; ?>
  </div>

<?php elseif ($pager == 'number') : ?>
