    ...
    <div id="main-content" class="row">
      ...
      <div id="content" class="<?php if (($page['sidebar_first']) && ($page['sidebar_second'])): print 'span6'; elseif (($page['sidebar_first']) || ($page['sidebar_second'])): print 'span9'; else: print 'span12'; endif; ?>">
        <div id="content-wrapper">
          ...
          <?php if ($no_popup_window == FALSE): ?>
            <div class="ibuttons">
              <span>Text Size: </span>
              <a href="#" title="Switch to Small Text Size (default)" id="text-small">S</a>
              <a href="#" title="Switch to Medium Text Size" id="text-medium">M</a>
              <a href="#" title="Switch to Large Text Size" id="text-large">L</a> |
            </div>
          <?php endif; ?>
