<div class="page-wrapper">
  <div id="skipnav" class="element-invisible">
    <div class="container">
      <p>Skip to:</p>
      <ul>
        <li><a href="#main" class="element-invisible element-focusable"><?php print t('Skip to content'); ?></a></li>
        <?php if ($main_menu): ?>
        <li><a href="#main-navigation" class="element-invisible element-focusable"><?php print t('Skip to navigation'); ?></a></li>
        <?php endif; ?>
      </ul>
    </div>
  </div>
  ...
  <?php if (($page['header']) || ($page['search_box']) || ($page['navigation'])): ?>
    <header id="header" class="subdomain-header js-header">
      <div class="subdomain-header__main">
        ...
        <?php endif; ?>
        <div id="main-navigation" class="subdomain-nav-search js-subdomain-nav-search">
            ...
            <div id="content-head" class="row-fluid">
              <div class="container">
                <div class="container-fluid">
                  ...
                  <?php if ($title && stripos($title, '[hide]') === FALSE): ?>
